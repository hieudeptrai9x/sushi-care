...
$baby = db()->prepare('SELECT name,nickname,birth_date,gender,avatar_url,birth_weight,birth_length,feeding_type,note,created_at,updated_at FROM babies WHERE id=?');
$baby->execute([$babyId]);
